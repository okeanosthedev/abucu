...
import sty from "./PlasmicDetailAbout.module.css"; // plasmic-import: Oln9733FJQPl/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__eti6T)}>
            <PlasmicImg__
          ...
          <div className={classNames(projectcss.all, sty.column__oFyHb)}>
            <h5

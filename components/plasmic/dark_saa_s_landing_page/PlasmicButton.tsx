...
import sty from "./PlasmicButton.module.css"; // plasmic-import: JL-HiSuSM6B5/css
    ...
    >
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__eplGn)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg___4D51V)}
                role={"img"}
              />
            ),
